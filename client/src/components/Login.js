    ...
    return (
        <div className="bg-gray-800 mt-10 m-auto w-96 h-96 shadow-2xl rounded-md">
            ...
            >
                ...
                <div className="mt-3">
                    <button className="bg-green-700 p-3 text-xl text-white rounded hover:opacity-80" type="submit">Log In</button>
                </div>
            </form>
            ...
            <div className="flex justify-center">
                <Link className="text-2xl text-white" to="/register">Register</Link>
            </div>
        </div>
